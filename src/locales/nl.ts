export const nlTranslation = {
  ...
  login: {
    ...
    magicStringPlaceholder: 'Plak een deelstring (hydra-player1-…)',
  ...
  common: {
    ...
    updaterInstallHint: 'Sluit Hydra Player en voer het installatieprogramma handmatig uit.',
  ...
  settings: {
    ...
    testingBtn: 'Testen…',
    serverCompatible: 'Gemaakt voor Navidrome. Andere Subsonic-compatibele servers (Gonic, Airsonic, …) kunnen met beperkte functionaliteit werken, omdat Hydra Player veel Navidrome-specifieke API-endpoints gebruikt.',
    ...
    lfmConnectDesc: 'Verbind je Last.fm-account om scrobbling en Nu bezig-updates rechtstreeks vanuit Hydra Player in te schakelen — geen Navidrome-configuratie vereist.',
    lfmOpenBrowser: 'Er opent een browservenster. Autoriseer Hydra Player op Last.fm en klik daarna op de knop hieronder.',
    ...
    offlineDirDesc: 'Opslaglocatie voor nummers die je offline beschikbaar maakt in Hydra Player.',
    ...
    audioOutputDeviceDesc: 'Kies via welk audioapparaat Hydra Player afspeelt. Wijzigingen worden direct toegepast en starten het huidige nummer opnieuw.',
    ...
    showTrayIconDesc: 'Toont het Hydra Player-pictogram in het systeemvak / de menubalk.',
    minimizeToTray: 'Minimaliseren naar systeemvak',
    minimizeToTrayDesc: 'Bij het sluiten van het venster blijft Hydra Player actief in het systeemvak in plaats van af te sluiten.',
    ...
    globalShortcutsNote: 'Werken systeembreed, ook als Hydra Player op de achtergrond draait. Vereist Ctrl, Alt of Super als modifier.',
  ...
  help: {
    ...
    a1: 'Hydra Player werkt met elke Subsonic-compatibele server: Navidrome, Gonic, Subsonic, Airsonic en anderen. Navidrome is de aanbevolen keuze.',
    q2: 'Hoe verbind ik me met mijn server?',
    a2: 'Open Instellingen en klik op "Server toevoegen". Voer de server-URL in (bijv. 192.168.1.100:4533), je gebruikersnaam en wachtwoord. Hydra Player test de verbinding voor het opslaan.',
    ...
    a12: 'Instellingen → Thema. Een ruime keuze aan thema\'s in 8 groepen: Hydra Player Themes, Mediaplayer, Besturingssystemen, Games, Films, Series, Social Media en Open Source Classics (Catppuccin, Nord, Gruvbox, Nightfox).',
    ...
    a16: 'Hydra Player scrobbelt rechtstreeks naar Last.fm — geen Navidrome-configuratie nodig. Verbind je Last.fm-account in Instellingen → Last.fm en schakel scrobbling in.',
    ...
    a20: 'Hydra Player is beschikbaar als .deb (Ubuntu/Debian), .rpm (Fedora/RHEL) en via AUR voor Arch/CachyOS (yay -S hydra-player). Er is geen AppImage. Controleer of PipeWire of PulseAudio actief is als er geen audio is.',
    ...
    q30: 'Toont Hydra Player songteksten?',
    a30: 'Ja. Klik op het microfoonpictogram in de spelerbalk om het tabblad Songteksten te openen. Hydra Player haalt teksten automatisch op van LRCLIB. Als gesynchroniseerde teksten beschikbaar zijn, wordt de actieve regel gemarkeerd en scrolt mee in realtime. Anders wordt de volledige tekst statisch getoond.',
    ...
    a35: 'Open een album en klik op het downloadpictogram in de albumkoptekst. Hydra Player downloadt alle nummers op de achtergrond. De voortgang wordt op de knop weergegeven. Na het cachen wordt het pictogram groen. Gecachte albums zijn te bekijken en verwijderen via de Offline bibliotheek (zijbalk).',
    ...
    a37: 'Hydra Player ondersteunt 1–5 sterrenwaarderingen via de OpenSubsonic API (vereist Navidrome ≥ 0.53). Beoordeel nummers in de tracklist van een album of afspeellijst, via het rechtsklikmenu of in de spelersbalk. Albums worden beoordeeld op hun detailpagina, artiesten op hun artiestenpagina.',
    ...
    a41: 'Instellingen → Uiterlijk → Thema automatisch wisselen: stel een dagthema en een nachtthema in met starttijden. Hydra Player wisselt automatisch op de ingestelde tijden.',
    ...
    a46: 'De Hot Cache (Alpha, Instellingen → Bibliotheek) laadt de volgende nummers in de wachtrij vooraf naar de schijf voor directe weergave. Hydra Player bewaart het huidige nummer en de volgende 5 en verwijdert oudere items wanneer de limiet is bereikt.',
    ...
    a48: 'Als de wachtrij leeg raakt en herhalen uitgeschakeld is, voegt Hydra Player automatisch willekeurige nummers toe zodat het afspelen nooit stopt. Automatisch toegevoegde nummers verschijnen onder het scheidingsteken "— Automatisch toegevoegd —". Schakel in/uit via het oneindig-pictogram in de wachtrij-header.',
    q49: 'Kan ik Hydra Player via de opdrachtregel bedienen?',
    a49: 'Ja. Voorbeelden: hydra-player --player play / pause / next / prev, --player volume 75, --player seek 15, --player mute, --player shuffle, --player repeat off|all|one. Ook: van server wisselen, audioapparaat wijzigen, bibliotheek filteren en zoeken. Volledige hulp: hydra-player --player --help.',
    ...
    a52: 'Instellingen → Audio → Uitvoerapparaat. Hydra Player toont alle beschikbare uitgangen. De selectie wordt direct van kracht. Gebruik de verversknop als een apparaat na het starten van de app is aangesloten.',
    ...
    a55: 'Ja. Het manifest op het apparaat bevat het gebruikte sjabloon. Op een ander besturingssysteem herkent Hydra Player bestaande bestanden correct, ook bij een ander sjabloon.',
    s9: 'Device Sync',
    q56: 'Wat is internetradio?',
    a56: 'De internetradiopagina speelt live streams af in Hydra Player. Stations komen van uw Navidrome-server — voeg ze toe via het beheerpaneel of importeer een .pls/.m3u-bestand. Afspelen gebruikt HTML5-audio.',
    ...
    s10: 'Internetradio',
    q58: 'Waar haalt Hydra Player songteksten vandaan?',
  ...
  orbit: {
    ...
    helperLink: 'Stuur deze link naar je gasten. Ze kunnen hem overal in Hydra Player plakken met Ctrl+V.',
    ...
    helpIntro: 'Orbit maakt van Hydra Player een gedeelde luisterruimte. Een host kiest de muziek; gasten luisteren synchroon mee en kunnen nummers voorstellen.',
    helpHostOnly: '(host)',
    ...
    helpSec4Body: 'Plak de uitnodigingslink ergens in Hydra Player met Ctrl+V / Cmd+V — de deelprompt verschijnt automatisch. Alternatief: "Orbit" → Deelnemen aan sessie → plak in het veld. Als de link naar een server verwijst waar je een account hebt, schakelt Hydra Player voor je. Bij meerdere accounts op die server vraagt een kleine kiezer welke te gebruiken.',
