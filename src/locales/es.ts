export const esTranslation = {
  ...
  login: {
    ...
    magicStringPlaceholder: 'Pega una cadena de invitación (hydra-player1-…)',
  ...
  common: {
    ...
    updaterInstallHint: 'Cierra Hydra Player y ejecuta el instalador manualmente.',
  ...
  settings: {
    ...
    testingBtn: 'Probando…',
    serverCompatible: 'Diseñado para Navidrome. Otros servidores compatibles con Subsonic (Gonic, Airsonic, …) pueden funcionar con funcionalidad reducida, ya que Hydra Player utiliza muchos endpoints específicos de la API de Navidrome.',
    ...
    lfmConnectDesc: 'Conecta tu cuenta de Last.fm para habilitar scrobbling y actualizaciones de "Reproduciendo Ahora" directamente desde Hydra Player — no requiere configuración de Navidrome.',
    lfmOpenBrowser: 'Se abrirá una ventana del navegador. Autoriza Hydra Player en Last.fm, luego click en el botón de abajo.',
    ...
    offlineDirDesc: 'Ubicación de almacenamiento para pistas que haces disponibles offline dentro de Hydra Player.',
    ...
    audioOutputDeviceDesc: 'Selecciona el dispositivo de audio que usa Hydra Player. Los cambios surten efecto de inmediato y reinician la pista actual.',
    ...
    showTrayIconDesc: 'Muestra el icono de Hydra Player en el área de notificación / barra de menú.',
    minimizeToTray: 'Minimizar a Bandeja',
    minimizeToTrayDesc: 'Al cerrar la ventana, mantener Hydra Player ejecutándose en la bandeja del sistema en lugar de salir.',
    ...
    aboutTitle: 'Acerca de Hydra Player',
    ...
    globalShortcutsNote: 'Funcionan en todo el sistema incluso cuando Hydra Player está en segundo plano. Requieren Ctrl, Alt o Super como modificador.',
  ...
  orbit: {
    ...
    helperLink: 'Envía este enlace a tus invitados. Pueden pegarlo en cualquier parte de Hydra Player con Ctrl+V.',
    ...
    helpIntro: 'Orbit convierte Hydra Player en una sala de escucha compartida. Un anfitrión elige la música; los invitados escuchan en sincronía y pueden sugerir canciones.',
    ...
    helpSec4Body: 'Pega el enlace de invitación en cualquier parte de Hydra Player con Ctrl+V / Cmd+V — el aviso para unirse aparece automáticamente. Alternativa: "Orbit" → Unirse a una sesión → pega en el campo. Si el enlace apunta a un servidor donde tienes una cuenta, Hydra Player cambia automáticamente. Si tienes más de una cuenta en ese servidor, un pequeño selector pregunta cuál usar.',
