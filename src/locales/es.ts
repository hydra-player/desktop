export const esTranslation = {
  ...
  help: {
    ...
    a1: 'Hydra Player funciona con cualquier servidor compatible con Subsonic: Navidrome, Gonic, Subsonic, Airsonic y otros. Navidrome es la opción recomendada.',
    q2: '¿Cómo me conecto a mi servidor?',
    a2: 'Abre Configuración y click en "Agregar Servidor". Ingresa la URL del servidor (ej. 192.168.1.100:4533), tu usuario y contraseña. Hydra Player prueba la conexión antes de guardar — nada se almacena si la conexión falla.',
    ...
    a12: 'Configuración → Tema. Elige entre una gran selección de temas en 8 grupos: Temas Hydra Player, Reproductores de Medios, Sistemas Operativos, Juegos, Películas, Series, Redes Sociales, y Clásicos Open Source (Catppuccin, Nord, Gruvbox, Nightfox).',
    ...
    a16: 'Hydra Player hace scrobbling directamente a Last.fm — no requiere configuración de Navidrome. Conecta tu cuenta de Last.fm en Configuración → Last.fm y habilita el scrobbling ahí.',
    ...
    a20: 'Hydra Player está disponible como .deb (Ubuntu/Debian), .rpm (Fedora/RHEL) y vía AUR en Arch/CachyOS (yay -S hydra-player). No hay AppImage. Si falta audio, asegúrate de que PipeWire o PulseAudio estén ejecutándose.',
    ...
    a35: 'Abre cualquier álbum y click en el icono de descarga en el encabezado del álbum. Hydra Player descarga todas las pistas en segundo plano. El progreso se muestra en el botón. Una vez completado, el icono se vuelve verde. Puedes ver y eliminar álbumes en caché en la página Biblioteca Offline (barra lateral).',
    ...
    a41: 'Configuración → Apariencia → Cambio Automático de Tema: define un tema de día y uno de noche con horas de inicio. Hydra Player cambia automáticamente a las horas configuradas. Cuando el programador está activo, una sugerencia en el selector de temas explica por qué la selección manual de tema no tiene efecto inmediato.',
    ...
    q44: '¿Qué es AutoEQ?',
    a44: 'El ecualizador de 10 bandas en Configuración → Audio incluye una búsqueda AutoEQ. Ingresa tu modelo de auriculares y Hydra Player obtiene un perfil de corrección de la base de datos AutoEQ y lo aplica automáticamente a las bandas del ecualizador.',
    ...
    a46: 'La Caché Activa (Alpha, Configuración → Biblioteca) precarga las siguientes varias pistas en tu cola al disco para que la reproducción comience instantáneamente sin demora de carga — especialmente útil en servidores lentos o remotos. Hydra Player mantiene la pista actual y las siguientes 5 en caché y elimina entradas antiguas cuando se alcanza el límite de tamaño. Puedes establecer el tamaño máximo de caché y una demora de espera para evitar cargas innecesarias cuando saltas rápidamente.',
    ...
    a48: 'Cuando la cola se vacía y la repetición está desactivada, Hydra Player añade pistas aleatorias automáticamente para que la reproducción nunca se detenga. Las pistas añadidas aparecen bajo el separador "— Añadido automáticamente —". Actívalo con el ícono de infinito en el encabezado de la cola.',
    q49: '¿Puedo controlar Hydra Player desde la línea de comandos?',
    a49: 'Sí. Ejemplos: hydra-player --player play / pause / next / prev, --player volume 75, --player seek 15, --player mute, --player shuffle, --player repeat off|all|one. También: cambiar servidor, dispositivo de audio, filtrar biblioteca y buscar. Ayuda completa: hydra-player --player --help.',
    ...
    a52: 'Ajustes → Audio → Dispositivo de salida. Hydra Player lista todas las salidas disponibles. La selección surte efecto inmediatamente. Usa el botón de actualizar si conectaste un dispositivo después de iniciar la app.',
    ...
    a55: 'Sí. El manifiesto guardado en el dispositivo incluye la plantilla usada. En otro SO con distinta plantilla, Hydra Player detecta correctamente los archivos existentes.',
    s9: 'Device Sync',
    q56: '¿Qué es la Radio por Internet?',
    a56: 'La página de Radio por Internet permite reproducir cualquier transmisión en vivo en Hydra Player. Las estaciones provienen de tu servidor Navidrome. La reproducción usa audio HTML5.',
    ...
    q58: '¿De dónde obtiene Hydra Player las letras?',
