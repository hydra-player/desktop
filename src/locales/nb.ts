export const nbTranslation = {
  ...
  help: {
    ...
    a1: 'Hydra Player fungerer med alle Subsonic-kompatible servere: Navidrome, Gonic, Subsonic, Airsonic og andre. Navidrome er det anbefalte valget.',
    q2: 'Hvordan kobler jeg til serveren min?',
    a2: 'Åpne Innstillinger og klikk på "Legg til server". Skriv inn server-URL-en (f.eks. 192.168.1.100:4533), brukernavn og passord. Hydra Player tester tilkoblingen før den lagrer – ingenting lagres hvis tilkoblingen mislykkes.',
    ...
    a12: 'Innstillinger → Tema. Velg fra et stort utvalg av temaer på tvers av 8 grupper: Hydra Player-temaer, mediaspiller, operativsystemer, spill, filmer, serier, sosiale medier og åpen kildekode-klassikere (Catppuccin, Nord, Gruvbox).',
    ...
    a16: 'Hydra Player scrobbler direkte til Last.fm - ingen Navidrome-konfigurasjon nødvendig. Koble til Last.fm-kontoen din i Innstillinger → Last.fm og aktiver scrobbling der.',
    ...
    a20: 'Hydra Player er tilgjengelig som .deb (Ubuntu/Debian), .rpm (Fedora/RHEL), og via AUR på Arch/CachyOS (yay -S hydra-player). Det finnes ingen AppImage. Hvis lyd mangler, sørg for at PipeWire eller PulseAudio kjører.',
    ...
    q30: 'Viser Hydra Player sangtekst?',
    a30: 'Ja. Klikk på mikrofonikonet i spillerlinjen, for å åpne Sangtekst-fanen i køpanelet. Hydra Player henter tekst automatisk fra LRCLIB. Hvis synkroniserte tekster er tilgjengelige, utheves den aktive linjen og ruller i sanntid mens sangen spilles av. Hvis bare ren tekst er tilgjengelig, vises fullteksten statisk.',
    q31: 'Kan jeg tilpasse hurtigtaster?',
    a31: 'Ja. Innstillinger → Tastatursnarveier lar deg tilordne handlinger i appen (Spill av/pause, Neste, Forrige, Volum opp/ned, Fullskjerm og mer) til en hvilken som helst tast. Innstillinger → Globale snarveier lar deg tilordne systemomfattende snarveier som utløses selv når Hydra Player er i bakgrunnen.',
    ...
    a35: 'Åpne et hvilket som helst album og klikk på nedlastingsikonet i albumoverskriften. Hydra Player laster ned alle spor i bakgrunnen. Fremdrift vises på knappen. Når bufren er lagret, blir ikonet grønt. Du kan vise og fjerne bufrede album på siden Offline bibliotek (sidefelt).',                                               
    ...
    a37: 'Hydra Player støtter 1–5 stjernevurderinger via OpenSubsonic API (krever Navidrome ≥ 0.53). Vurder sanger i sporlistene, via høyreklikk-menyen eller i spillerlinjen. Album vurderes på detaljsiden, artister på artistsiden.',
    ...
    a41: 'Innstillinger → Utseende → Bytt tema automatisk: angi et dagstema og et nattstema med starttider. Hydra Player bytter automatisk på de angitte tidspunktene.',
    ...
    a46: 'Hurtigbuffer (Alpha, Innstillinger → Bibliotek) forhåndslaster de neste sporene i køen til disk for umiddelbar avspilling. Hydra Player beholder gjeldende spor og de neste 5 og fjerner eldre innslag når grensen nås.',
    ...
    a48: 'Når køen tømmes og gjentakelse er deaktivert, legger Hydra Player automatisk til tilfeldige spor så avspillingen aldri stopper. Automatisk tillagte spor vises under skillelinjen "— Lagt til automatisk —".',
    q49: 'Kan jeg styre Hydra Player fra kommandolinjen?',
    a49: 'Ja. Eksempler: hydra-player --player play / pause / next / prev, --player volume 75, --player seek 15, --player mute, --player shuffle, --player repeat off|all|one. Også: bytt server, lydenhet, filtrer bibliotek og søk. Full hjelp: hydra-player --player --help.',
    ...
    a52: 'Innstillinger → Lyd → Utgangsenhet. Hydra Player viser alle tilgjengelige utganger. Valget trer i kraft umiddelbart.',
    ...
    a55: 'Ja. Manifestet på enheten inneholder malen som ble brukt. På et annet OS gjenkjenner Hydra Player eksisterende filer korrekt.',
    s9: 'Device Sync',
    q56: 'Hva er internettradio?',
    a56: 'Internettradiosiden lar deg spille av direkte strømmer i Hydra Player. Stasjoner hentes fra Navidrome-serveren din. Avspilling bruker HTML5-lyd.',
    ...
    s10: 'Internettradio',
    q58: 'Hvor henter Hydra Player sangtekster fra?',
