export const frTranslation = {
  ...
  login: {
    ...
    magicStringPlaceholder: 'Collez une chaîne de partage (hydra-player1-…)',
  ...
  common: {
    ...
    updaterInstallHint: 'Fermez Hydra Player et lancez le programme d\'installation manuellement.',
  ...
  settings: {
    ...
    serverCompatible: 'Conçu pour Navidrome. Les autres serveurs compatibles Subsonic (Gonic, Airsonic, …) peuvent fonctionner avec des fonctionnalités réduites, car Hydra Player utilise de nombreux endpoints d’API spécifiques à Navidrome.',
    ...
    lfmConnectDesc: 'Connectez votre compte Last.fm pour activer le scrobbling et les mises à jour « En cours de lecture » depuis Hydra Player — aucune configuration Navidrome requise.',
    lfmOpenBrowser: 'Une fenêtre de navigateur s\'ouvrira. Autorisez Hydra Player sur Last.fm, puis cliquez sur le bouton ci-dessous.',
    ...
    offlineDirDesc: 'Emplacement de stockage des titres rendus disponibles hors ligne dans Hydra Player.',
    ...
    audioOutputDeviceDesc: 'Choisissez le périphérique audio utilisé par Hydra Player. Les changements sont immédiats et relancent la piste en cours.',
    ...
    showTrayIconDesc: 'Affiche l\'icône Hydra Player dans la zone de notification / barre des menus.',
    minimizeToTray: 'Réduire dans la barre système',
    minimizeToTrayDesc: 'Lors de la fermeture, Hydra Player continue de fonctionner dans la barre système au lieu de se fermer.',
    ...
    aboutTitle: 'À propos de Hydra Player',
    ...
    globalShortcutsNote: 'Fonctionnent à l\'échelle du système, même quand Hydra Player est en arrière-plan. Nécessite Ctrl, Alt ou Super comme modificateur.',
  ...
  help: {
    ...
    a1: 'Hydra Player fonctionne avec tout serveur compatible Subsonic : Navidrome, Gonic, Subsonic, Airsonic, et autres. Navidrome est recommandé.',
    q2: 'Comment me connecter à mon serveur ?',
    a2: 'Ouvrez les Paramètres et cliquez sur « Ajouter un serveur ». Saisissez l\'URL du serveur (ex. 192.168.1.100:4533), votre nom d\'utilisateur et mot de passe. Hydra Player teste la connexion avant d\'enregistrer.',
    ...
    a12: 'Paramètres → Thème. Un grand choix de thèmes en 8 groupes : Hydra Player Themes, Mediaplayer, Systèmes d\'exploitation, Jeux, Films, Séries, Réseaux sociaux et Open Source Classics (Catppuccin, Nord, Gruvbox, Nightfox).',
    ...
    a16: 'Hydra Player envoie les scrobbles directement à Last.fm — aucune configuration Navidrome nécessaire. Connectez votre compte dans Paramètres → Last.fm et activez le scrobbling.',
    ...
    a20: 'Hydra Player est disponible en .deb (Ubuntu/Debian), .rpm (Fedora/RHEL) et via AUR sur Arch/CachyOS (yay -S hydra-player). Il n\'y a pas d\'AppImage. Si l\'audio ne fonctionne pas, vérifiez que PipeWire ou PulseAudio est actif.',
    ...
    q30: 'Hydra Player affiche-t-il les paroles ?',
    a30: 'Oui. Cliquez sur l\'icône microphone dans la barre du lecteur pour ouvrir l\'onglet Paroles. Hydra Player récupère automatiquement les paroles depuis LRCLIB. Si des paroles synchronisées sont disponibles, la ligne active est mise en évidence et défile en temps réel. Sinon, le texte complet est affiché statiquement.',
    ...
    a37: 'Hydra Player prend en charge les notes de 1 à 5 étoiles via l\'API OpenSubsonic (Navidrome ≥ 0.53 requis). Notez les morceaux dans la liste de pistes d\'un album ou d\'une playlist, via le menu contextuel ou directement dans la barre du lecteur. Les albums sont notés sur leur page de détail, les artistes sur leur page.',
    ...
    a41: 'Paramètres → Apparence → Changer de thème automatiquement : définissez un thème de jour et un thème de nuit avec des heures de début. Hydra Player bascule automatiquement à l\'heure configurée.',
    ...
    a46: 'Le Hot Cache (Alpha, Paramètres → Bibliothèque) précharge les prochains morceaux de la file sur le disque pour une lecture instantanée. Hydra Player conserve le morceau actuel et les 5 suivants et évince les anciens quand la limite est atteinte.',
    ...
    a48: 'Lorsque la file se vide et que la répétition est désactivée, Hydra Player ajoute silencieusement des pistes aléatoires pour que la lecture ne s\'arrête jamais. Les pistes ajoutées automatiquement apparaissent sous le séparateur « — Ajouté automatiquement — ». Activez/désactivez via l\'icône infini dans l\'en-tête de la file.',
    q49: 'Puis-je contrôler Hydra Player en ligne de commande ?',
    a49: 'Oui. Exemples : hydra-player --player play / pause / next / prev, --player volume 75, --player seek 15, --player mute, --player shuffle, --player repeat off|all|one, --player star / unstar, --player rating 1-5. Aussi : changer de serveur, d\'appareil audio, filtrer la bibliothèque, lancer un mix instantané et rechercher. Aide complète : hydra-player --player --help.',
    ...
    a52: 'Paramètres → Audio → Périphérique de sortie. Hydra Player liste tous les périphériques disponibles. La sélection prend effet immédiatement. Utilisez le bouton d\'actualisation si un périphérique a été branché après le démarrage de l\'application.',
    ...
    a55: 'Oui. Le manifeste écrit sur l\'appareil contient le modèle utilisé lors de la synchronisation. Sur un autre OS avec un modèle différent, Hydra Player détecte correctement les fichiers existants.',
    s9: 'Device Sync',
    q56: 'Qu\'est-ce que la radio Internet ?',
    a56: 'La page Radio Internet permet de lire n\'importe quel flux en direct dans Hydra Player. Les stations proviennent de votre serveur Navidrome — ajoutez-les via le panneau d\'administration ou importez un fichier .pls/.m3u. La lecture utilise l\'audio HTML5.',
    ...
    s10: 'Radio Internet',
    q58: 'D\'où Hydra Player récupère-t-il les paroles ?',
  ...
  orbit: {
    ...
    helperLink: 'Envoie ce lien à tes invités. Ils peuvent le coller n\'importe où dans Hydra Player avec Ctrl+V.',
    ...
    helpIntro: 'Orbit transforme Hydra Player en salle d\'écoute partagée. Un hôte choisit la musique ; les invités écoutent en synchro et peuvent suggérer des morceaux.',
    helpHostOnly: '(hôte)',
    ...
    helpSec4Body: 'Colle le lien d\'invitation n\'importe où dans Hydra Player avec Ctrl+V / Cmd+V — l\'invite apparaît automatiquement. Alternative : « Orbit » → Rejoindre une session → colle dans le champ. Si le lien pointe vers un serveur où tu as un compte, Hydra Player bascule automatiquement. Si tu as plusieurs comptes sur ce serveur, un sélecteur demande lequel utiliser.',
